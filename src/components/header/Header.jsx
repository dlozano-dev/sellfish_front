    ...
    return (
        <div className='flex justify-between items-center pl-4 w-full h-20'>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className='absolute right-10 top-15 mt-2 w-48 bg-white rounded-lg shadow-lg text-gray-600 fill-gray-600'
                    >
                        <div className='flex justify-between items-center px-4 py-2 border-b'>
                            <span className='text-gray-700 font-semibold'>Menu</span>
                            <CloseIcon className='w-5 h-5 cursor-pointer hover:text-black'
                        ...
                        <div
                            className='hover:cursor-pointer hover:bg-gray-100 hover:fill-black flex items-center justify-between'>
                            <div
                                className='flex items-center w-full px-4 py-2 hover:text-black transition-transform duration-500 hover:translate-x-[10%]'>
                                <svg className='w-4 h-4 mr-4 fill-none' xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 24 24">
                                    <path className='stroke-gray-600 stroke-[1.5] stroke-round'
                        ...
                        <div onClick={() => setUser(null)}
                            ...
                            <div
                                className='flex items-center w-full px-4 py-2 hover:text-black transition-transform duration-500 hover:translate-x-[10%]'>
                                <svg className='w-4 h-4 mr-4' xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 471.2 471.2"
                                     xml:space="preserve"><g><g xmlns="http://www.w3.org/2000/svg"><path d="M227.619,444.2h-122.9c-33.4,0-60.5-27.2-60.5-60.5V87.5c0-33.4,27.2-60.5,60.5-60.5h124.9c7.5,0,13.5-6,13.5-13.5    s-6-13.5-13.5-13.5h-124.9c-48.3,0-87.5,39.3-87.5,87.5v296.2c0,48.3,39.3,87.5,87.5,87.5h122.9c7.5,0,13.5-6,13.5-13.5    S235.019,444.2,227.619,444.2z"/><path
                                    d="M450.019,226.1l-85.8-85.8c-5.3-5.3-13.8-5.3-19.1,0c-5.3,5.3-5.3,13.8,0,19.1l62.8,62.8h-273.9c-7.5,0-13.5,6-13.5,13.5    s6,13.5,13.5,13.5h273.9l-62.8,62.8c-5.3,5.3-5.3,13.8,0,19.1c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4l85.8-85.8    C455.319,239.9,455.319,231.3,450.019,226.1z"/></g></g></svg>
                                <span>Log out</span>
                            </div>
                        </div>
                    </motion.div>
            ...
            <div className='flex space-x-4 p-8 items-center'>
                <img src={String(dagger_icon)} alt='Favorite Icon'
